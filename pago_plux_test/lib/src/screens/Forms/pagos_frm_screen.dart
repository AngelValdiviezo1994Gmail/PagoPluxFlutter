...
class PagosFrmScreen extends StatefulWidget {
  ...
  PagosFrmScreen({Key? key}) : super (key: key);
                                                ...
                                                child: AnimatedBuilder(
                                                  ...
                                                  builder: (context, child) => Transform.scale(
                                                    ...
                                                    child: Container(
                                                        width: 60,
                                                        height: 60,
                                                        decoration: BoxDecoration(shape: BoxShape.circle, color: objColoresAppForms.pluxNaranja),
                                                        child: const Icon(
...
formsPagosItemsDesign(label, item, idForm, subItem) {
