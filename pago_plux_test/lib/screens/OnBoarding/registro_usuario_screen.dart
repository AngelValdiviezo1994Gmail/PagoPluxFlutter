...
import 'package:pago_plux_test/_environments/index.dart';
//ignore: unused_import
import 'package:pago_plux_test/bloc/index.dart';
import 'package:pago_plux_test/screens/index.dart';
import 'package:pago_plux_test/services/index.dart';
import 'package:pago_plux_test/ui/index.dart';
//ignore: unused_import
import 'package:pago_plux_test/utils/index.dart';
//ignore: unused_import
import 'package:pago_plux_test/widgets/index.dart';
...
import 'package:flutter_awesome_alert_box/flutter_awesome_alert_box.dart';
import 'package:pago_plux_test/animations/fade_animation.dart';
import '../../models/index.dart';
//ignore: unused_import
import 'package:page_transition/page_transition.dart';

String tipoClienteTipoIdent = '';
ResponseValidation objRespuestasTipoIdent = ResponseValidation();
...
ColoresApp objColoresAppDatPers = ColoresApp();
String apiKey = '';
...
class RegistroUsuarioScreen extends StatefulWidget {
  ...
  RegistroUsuarioScreen({Key? key}) : super (key: key);

  static const String routerName = 'registroUsuarioScreen';

  @override
  RegistroUsuarioScreenState createState() => RegistroUsuarioScreenState();
}

class RegistroUsuarioScreenState extends State<RegistroUsuarioScreen> with TickerProviderStateMixin {
  ...
  //late CustomImageCropController controllerRecorte;
        ...
        if (status == AnimationStatus.completed) {
          ...
          Navigator.pushReplacement(
            ...
            PageTransition(
              ...
              child: PassWordScreen(objProspectoEntra: varObjProspecto)
            )
          );
          */
        }
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Center(
                            child: AutoSizeText(
                              ...
                              style: TextStyle(
                                color: objColoresAppDatPers.pluxNaranja
                              ),
                              maxLines: 1,
                        ...
                        Container(
                          ...
                          child: formItemsDesign(
                            const Text('Mi nombre es: ',style: TextStyle(color: Colors.white, fontSize: 18),),
                            TextFormField(
                        ...
                        Container(
                          ...
                          height: sizeFrmDatosPers.height * 0.13,
                          child: formItemsDesign(
                            Text('Mi correo es: ',style: TextStyle(color: Colors.white, fontSize: 18),),
                            TextFormField(
                              inputFormatters: [FilteringTextInputFormatter.deny(RegExp(regexToRemoveEmoji))],
                        ...
                        Container(
                          ...
                          child: formItemsDesign(
                            ...
                            TextFormField(
                              ...
                              autocorrect: false,
                              controller: txtClave,
                              obscureText: clienteForm.varIsOscured,
                              maxLength: 20,
                              keyboardType: !clienteForm.varIsOscured
                                  ? TextInputType.text
                              ...
                              decoration: InputDecorations.authInputDecoration(
                                ...
                                colorBordes: Colors.white,
                                colorTexto: Colors.white,
                                tamanioLetraLabel: 15,
                                sufixIcon: !clienteForm.varIsOscured
                                  ? Icons.visibility_off
                                  : Icons.visibility,
                                varOnPress: () {
                                  clienteForm.varIsOscured = !clienteForm.varIsOscured;
                                },
                              ),
                              onChanged: ((value) {
                                clienteForm.varPassWord = value;
                                /*
                                passWordNueva = value;
                        ...
                        FadeAnimation(
                          ...
                          1.6,
                          AnimatedBuilder(
                            animation: _scaleController ?? AnimationController(vsync: this, duration: const Duration(milliseconds: 300)),
                            builder: (context, child) =>
                            Transform.scale(
                              scale: _scaleAnimation!.value,
                              child: Center(
                                child: AnimatedBuilder(
                                  animation: _widthController ?? AnimationController(vsync: this, duration: const Duration(milliseconds: 600)),
                                                ...
                                                child: AnimatedBuilder(
                                                  ...
                                                  builder: (context, child) => Transform.scale(
                                                    ...
                                                    child: Container(
                                                        width: 60,
                                                        height: 60,
                                                        decoration: BoxDecoration(shape: BoxShape.circle, color: objColoresAppDatPers.pluxNaranja),
                                                        child: const Icon(
