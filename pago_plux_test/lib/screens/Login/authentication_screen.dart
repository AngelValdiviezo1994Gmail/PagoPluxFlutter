          ...
          children: <Widget>[
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const AutoSizeText('Inicia sesión', style: TextStyle(color: Colors.white,), presetFontSizes: [40,30,20,10]),
                  ),
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      //initialValue: varObjetoProspectoFunc?.co ?? '',
            ...
            Container(
              ...
              child: MaterialButton(
                ...
                elevation: 10,
                color: objColoresLog.pluxNaranja,
                child: Container(
                  color: Colors.transparent,
                  child: !autenticacionService.varIsLoading
                  ? const Text(
                      'Continuar',
                ...
                onPressed: () async {
                    ...
                    if(txtCorreo.text.isEmpty) {
                      Navigator.push(
                        ...
                        CupertinoPageRoute(
                          builder: (context) => 
                            AutenticacionErrorScreen(null,'Ingresa tu correo.','','numIdentVacia.png',false,false,'','')
                        ),
                      );
                      return;
                    }
                    ...
                    autenticacionService.varIsLoading = true;
                    
                    String respt = ValidacionesUtils().validaCorreo(txtCorreo.text);
            
                    if(respt.isEmpty) {
                      autenticacionService.varIsLoading = false;
                    ...
                    if (respt.toLowerCase() == 'ok') {
                      ...
                      Navigator.pushReplacement(
                        context,
                        CupertinoPageRoute(builder: (context) => ContraseniaScreen(correoUser: txtCorreo.text)),
                      );
                    } 
                    else {
                      if(!autenticacionService.objClienteValido!.succeeded) {
                        // ignore: use_build_context_synchronously
                        Navigator.push(
                          context,
                          CupertinoPageRoute(
              ...
              child: Container(
                ...
                child: MaterialButton(
                  child: Container(
                    ...
                    child: AutoSizeText(
                      'Quiero suscribirme',
                      style: TextStyle(color: objColoresLog.pluxNaranja),
                      maxLines: 2,
      ...
      child: Form(
        ...
        TextFormField(
          ...
          onChanged: (value) {
            ...
            numIdentAut = value;
            //varControllerValidarPrinc!.text = value;
          },
          validator: (value) {
